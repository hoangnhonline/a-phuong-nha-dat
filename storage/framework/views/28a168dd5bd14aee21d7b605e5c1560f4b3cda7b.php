							...
							<form method="POST" action="<?php echo e(route('post-ky-gui')); ?>" class="block-hover-selectpicker">
								...
								<div class="form-horizontal">
									<div class="form-group">
										...
										<div class="col-sm-9">
									  		<input type="radio" name="type" value="1" id="type_1" <?php echo e(old('type', $type) == 1 ? "checked" : ""); ?>>
									  		<label for="type_1">BĐS bán</label>
									  		&nbsp;&nbsp;&nbsp;
									  		<input type="radio" name="type" value="2" id="type_2" <?php echo e(old('type', $type) == 2 ? "checked" : ""); ?>>
