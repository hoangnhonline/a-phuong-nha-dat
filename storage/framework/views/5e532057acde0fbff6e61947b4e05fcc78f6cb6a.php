...
<article class="block block-breadcrumb">
  <ul class="breadcrumb">
    ...
    <li class="active"><a href="<?php echo e(route('danh-muc', $detailPage->slug)); ?>" title="<?php echo e($detailPage->title); ?>"><?php echo e($detailPage->title); ?></a></li>
  </ul>
       ...
       <div class="row">
                  ...
                  <div class="block_content">
                      ...
                      <div class="layered layered-category">
                          <div class="layered-content">
                              <ul class="tree-menu">
                                  <li <?php echo e($detailPage->slug == 'gioi-thieu' ? 'class=active' : ''); ?>><span></span><a href="<?php echo e(route('danh-muc', 'gioi-thieu')); ?>">Giới thiệu</a></li>                               
                                  <li <?php echo e($detailPage->slug == 'bao-mat-thong-tin' ? 'class=active' : ''); ?>><span></span><a href="<?php echo e(route('danh-muc', 'bao-mat-thong-tin')); ?>">Bảo mật thông tin</a></li>                      
                                  <li <?php echo e($detailPage->slug == 'phuong-thuc-thanh-toan' ? 'class=active' : ''); ?>><span></span><a href="<?php echo e(route('danh-muc', 'phuong-thuc-thanh-toan')); ?>">Phương thức thanh toán</a></li>
                                  <li <?php echo e($detailPage->slug == 'hinh-thuc-van-chuyen' ? 'class=active' : ''); ?>><span></span><a href="<?php echo e(route('danh-muc', 'hinh-thuc-van-chuyen')); ?>">Hình thức vận chuyển</a></li>
                                  <li <?php echo e($detailPage->slug == 'chinh-sach-bao-hanh' ? 'class=active' : ''); ?>><span></span><a href="<?php echo e(route('danh-muc', 'chinh-sach-bao-hanh')); ?>">Chính sách bảo hành</a></li>                                 
                              </ul>
                          </div>
                      </div>
                      <!-- ./layered -->
          ...
          <div class="center_column col-xs-12 col-sm-9" id="center_column">
              ...
              <h2 class="page-heading">
                  <span class="page-heading-title2"><?php echo e($detailPage->title); ?></span>
              </h2>
              <!-- Content page -->
