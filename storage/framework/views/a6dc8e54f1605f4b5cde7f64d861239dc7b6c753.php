		...
		<ul class="nav nav-tabs nav-tabs-langding" id="nav-tabs-langding" role="tablist">
			<li role="presentation" >
				<p class="tabs-item-logo">
					<i class="icon">
						<img src="<?php echo e($detail->logo_url ? Helper::showImage($detail->logo_url) : URL::asset('backend/dist/img/no-image.jpg')); ?>" alt="<?php echo e($detail->name); ?>">
					</i>
				</p>
			</li>
			<?php if(in_array(1, $tabArr)): ?>
			<li role="presentation" <?php if($tab_id == 1): ?> class="active" <?php endif; ?>>
				<a href="<?php echo e(route('tab', [$detail->slug, 'gioi-thieu'])); ?>" >
					<i class="icon">
