...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('articles-cate.index')); ?>" style="margin-bottom:5px">Quay lại</a>
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('articles-cate.index')); ?>">Hủy</a>
            </div>
