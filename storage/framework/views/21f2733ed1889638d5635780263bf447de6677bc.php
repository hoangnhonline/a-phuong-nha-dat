              ...
              <?php endif; ?>
                <div class="form-group">
                  ...
                  <select class="form-control" name="type" id="type">                                
                    <option value="1" <?php echo e(1 ==  old('type') ? "selected" : ""); ?>>BĐS</option>
                    <option value="2" <?php echo e(2 ==  old('type') ? "selected" : ""); ?>>Bài viết</option>
                    <option value="3" <?php echo e(3 ==  old('type') ? "selected" : ""); ?>>Tiện ích xung quanh</option>
                  </select>
                </div>
