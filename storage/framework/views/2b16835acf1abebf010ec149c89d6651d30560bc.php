...
<article class="block-breadcrumb-page">
	<ul class="breadcrumb">	
		...
		<li>					
			<a href="<?php echo e(route('danh-muc', $rsLoai->slug )); ?>"><?php echo e($rsLoai->name); ?></a>			
		</li>
	...
	<article class="block block-cate-news-detail">
		...
		<div class="cate-news-detail-location">
	    	...
	    	<?php echo e(Helper::getName($detail->district_id, 'district')); ?> - <?php echo e(Helper::getName($detail->city_id, 'city')); ?>

	    </div><!-- /cate-news-detail-location -->
	    <ul class="cate-news-detail-price clearfix">
			<li><p>Giá: <span><?php echo e($detail->price); ?> <?php echo e(Helper::getName($detail->price_unit_id, 'price_unit')); ?></span></p></li>
			<li><p>Diện tích: <span><?php echo e($detail->area); ?> m<sup>2</sup></span></p></li>
				...
				<div role="tabpanel" class="tab-pane active" id="home">
					<div id="slide-detail">
						<ul class="slide-detail">
							...
							<li><img src="<?php echo e(Helper::showImage($hinh['image_url'])); ?>" /></li>
                            <?php endforeach; ?>
						</ul>
						<ul id="bx-pager-detail">
							<?php $i = 0; ?>
							<?php foreach( $hinhArr as $hinh ): ?>							
							<li><a data-slide-index="<?php echo e($i); ?>" href=""><img src="<?php echo e(Helper::showImage($hinh['image_url'])); ?>" /></a></li>
							<?php $i++; ?>
							<?php endforeach; ?>
						</ul>
					</div>
	    	...
	    	<div class="col-sm-6">
	    		...
	    		<table class="table table-customize">	    			
	    			...
	    			<tr>
	    				...
	    				<td><?php echo e(Helper::getName($detail->estate_type_id, 'estate_type')); ?></td>
	    			</tr>
	    			<tr>
	    			...
	    			<tr>
	    				<td><b>Hướng nhà</b></td>
	    				<td><?php echo e($detail->direction_id > 0 ? Helper::getName($detail->direction_id, 'direction')  : "KXD"); ?></td>
	    			</tr>
	    			<tr>
	    				<td><b>Số phòng</b></td>
	    	...
	    	<div class="col-sm-6">
	    		...
	    		<table class="table table-customize">
	    			<tr>
	    				...
	    				<td><?php echo e($detail->contact_name); ?></td>
	    			</tr>
	    			<tr>
	    				<td><b>Địa chỉ</b></td>
	    				<td><?php echo e(Helper::getName($detail->district_id, 'district')); ?> - <?php echo e(Helper::getName($detail->city_id, 'city')); ?></td>
	    			</tr>
	    			<tr>
	    				<td><b>Di động</b></td>
	    			...
	    			<tr>
	    				<td><b>Email</b></td>
	    				<td><?php echo e($detail->contact_email); ?></td>
	    			</tr>
	    		</table>
	    	</div>
					...
					<div class="col-sm-6 col-xs-12">
						<div class="news-with-region-item clearfix">
							<div class="news-with-region-title">
								<a href="<?php echo e(route('chi-tiet', [$product->slug_loai, $product->slug, $product->id])); ?>" title="<?php echo e($product->title); ?>"><?php echo e($product->title); ?></a>
							</div>
							<div class="news-with-region-content">
								<div class="news-with-region-img">
									<a  href="<?php echo e(route('chi-tiet', [$product->slug_loai, $product->slug, $product->id])); ?>"><img  title="" src="<?php echo e($product->image_urls ? Helper::showImageThumb($product->image_urls) : URL::asset('backend/dist/img/no-image.jpg')); ?>" alt="" ></a>
								</div>
								<div class="news-with-region-info">
									<p>
			                            <label>Giá:</label>
			                            <span><?php echo e($product->price); ?> <?php echo e(Helper::getName($product->price_unit_id, 'price_unit')); ?></span>
			                        </p>
			                        <p>
			                            <label>Diện tích:</label>
			                            <?php echo e($product->area); ?> m<sup>2</sup>
			                        </p>
			                        <p>
			                            <label>Vị trí:</label>
			                            <?php echo e(Helper::getName($product->district_id, 'district')); ?> - <?php echo e(Helper::getName($product->city_id, 'city')); ?>
